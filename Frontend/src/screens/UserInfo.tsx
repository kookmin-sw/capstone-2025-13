...
export default function UserInfo() {
    ...
    const getGenderLabel = (
        gender: string | null | undefined | GenderEnum
    ): string => {
        switch (gender) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const initialData: UserData = {
                ...
                secondPassword:
                    Number(await AsyncStorage.getItem("@secondPassword")) ||
                    1111,
            ...
            try {
                if (originalData?.secondPassword !== userData.secondPassword) {
                    await AsyncStorage.setItem(
                        "@secondPassword",
                        userData.secondPassword.toString()
                    );
            ...
            <View style={userInfoStyles.whiteBox}>
                ...
                <InfoRow
                    ...
                    onChangeText={(text) => {
                        ...
                        setUserData({
                            ...userData,
                            secondPassword: Number(numericText),
                        });
                    }}
                    secureTextEntry={!editMode}
                    editable={editMode}
