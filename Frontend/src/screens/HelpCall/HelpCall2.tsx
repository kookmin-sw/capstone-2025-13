...
const phoneData = [
    {
        ...
        data: [
            ...
            {
                name: "117 학교 · 여성폭력 및 성매매피해자 신고센터",
                phone: "117",
            },
        ],
    },
        ...
        data: [
            {
                name: "한국생명존중희망재단",
                phone: "02-3706-0500",
                website: "www.kfsp.or.kr",
            },
            {
                name: "서울시자살예방센터",
                phone: "02-3458-1000",
                website: "www.suicide.or.kr",
            },
            {
                name: "경기도자살예방센터",
                phone: "031-212-0437",
                website: "www.mentalhealth.or.kr",
            },
            {
                name: "인천광역시자살예방센터",
                phone: "032-468-9917",
                website: "www.ispc.or.kr",
            },
            {
                name: "강원특별자치도자살예방센터",
                phone: "033-251-1970",
                website: "www.gwmh.or.kr",
            },
            {
                name: "충청북도광역자살예방센터",
                phone: "043-217-0597",
                website: "cbsmind.or.kr",
            },
            {
                name: "충청남도광역자살예방센터",
                phone: "041-566-9184",
                website: "www.chmhc.or.kr",
            },
            {
                name: "대전광역자살예방센터",
                phone: "042-486-0005",
                website: "www.djpmhc.or.kr",
            },
            {
                name: "광주자살예방센터",
                phone: "062-600-1930",
            ...
            },
            {
                name: "대구광역자살예방센터",
                phone: "053-256-0199",
                website: "mental.dgmhc.or.kr",
            },
            {
                name: "울산광역자살예방센터",
                phone: "052-716-7199",
                website: "www.usspc.or.kr",
            },
            {
                name: "부산광역자살예방센터",
                phone: "051-242-2575",
        ...
        data: [
            {
                name: "서울해바라기아동센터",
                phone: "02-3274-1375",
                website: "www.child1375.or.kr",
            },
            {
                name: "아동권리보장원",
                phone: "02-6454-8500",
                website: "www.ncrc.or.kr",
            },
            {
                name: "한국청소년상담복지개발원",
                phone: "051-662-3000",
                website: "www.kyci.or.kr",
            },
            {
                name: "한국청소년쉼터협의회",
                phone: "02-403-9171",
                website: "www.jikimi.or.kr",
            },
        ],
    },
    {
        ...
        data: [
            {
                name: "한국도박문제예방치유원",
                phone: "1336 (24시간)",
                website: "www.kcgp.or.kr",
            },
            {
                name: "한국마약퇴치운동본부",
                phone: "02-2677-2245",
                website: "www.drugfree.or.kr",
            },
        ],
    },
];
    ...
    return (
        <View style={helpCallStyles.container}>
            <View style={helpCallStyles.headerBox}>
                ...
                <Text style={helpCallStyles.headerText}>헬프콜</Text>
                <ScrollView
                    horizontal
            ...
            <ScrollView style={helpCallStyles.contentContainer}>
                {filteredData.map((item, index) => (
                    <View key={index} style={helpCallStyles.itemContainer}>
                        <Text style={helpCallStyles.itemTitle}>
                            {item.name}
                        </Text>
                        <Text
                        ...
                        {"website" in item && item.website && (
                            <Text
                                ...
                                onPress={() =>
                                    Linking.openURL(`http://${item.website}`)
                                }
                            >
                                {item.website}
                            </Text>
