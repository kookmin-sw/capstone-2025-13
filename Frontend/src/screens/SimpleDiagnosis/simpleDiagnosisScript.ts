...
export const SimpleDiagnosisScript = ({ nickname }: SimpleDiagnosisScriptProp): ScriptSegment[] => [
    ...
    },
    {
      index: 3,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-3-1.png"),
      name: "세잎이",
      text: "(...끼익)\n어머 너 누구야?\n우리 어디서 본 적 있나?",
    },
    {
        index: 4,
        type: "options",
        backgroundImage: require("../../assets/Images/simple-3-2.png"),
        options: [
    ...
    },
    {
      index: 7,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-3-3.png"),
      name: "세잎이",
      text: "들어와, 들어와!\n너 이름이 뭐니?",
    },
    {
    ...
    },
    {
      index: 11,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-3-4.png"),
      name: "세잎이",
    ...
    },
    {
      index: 13,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-4-1.png"),
      name: "세잎이",
      text: "아하 그렇구나!\n여기 물!",
    },
    {
      index: 14,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-4-3.png"),
      name: "세잎이",
    ...
    },
    {
      index: 15,
      type: "options",
      backgroundImage: require("../../assets/Images/simple-4-2.png"),
      options: [
    ...
    },
    {
      index: 16,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-4-4.png"),
      name: "세잎이",
    ...
    },
    {
      index: 17,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-4-5.png"),
      name: "세잎이",
    ...
    },
    {
      index: 22,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-4-6.png"),
      name: "세잎이",
      text: "그래, 그럴 때가 있지~",
    },
    {
        index: 23,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-4-7.png"),
        name: "세잎이",
        text: "(꼬르륵..)\n나 지금 밥 먹으려고 했는데\n너도 먹고 갈래?",
      },
    {
    ...
    index: 27,
    type: "story",
    backgroundImage: require("../../assets/Images/simple-6-1.png"),
    name: "세잎이",
    ...
    index: 29,
    type: "story",
    backgroundImage: require("../../assets/Images/simple-7-1.png"),
    name: "세잎이",
    text: "비오니까\n괜히 좀 가라앉는 기분이네,,",
    },
    {
    ...
    },
    {
        index: 31,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-7-2.png"),
        name: "세잎이",
        text: "분위기 띄울 겸\n같이 게임 한 판 할래??",
    },
    {
    ...
    },
    {
        index: 33,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-7-3.png"),
        name: "세잎이",
        text: "오 잘하는데?",
    },
    {
        index: 34,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-7-4.png"),
        name: "세잎이",
        text: "(하암~)\n게임했더니 피곤하다!\n이만 자러 가자!",
    },
    {
    ...
    },
    {
      index:38,
      type: "story",
      backgroundImage: require("../../assets/Images/simple-10-1.png"),
      name: "세잎이",
      text: "잘잤어?",
  },
    {
    ...
    },
    {
        index:40,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-10-2.png"),
        name: "세잎이",
        text: "그렇구나!\n나는 오늘 하루 너무 기대 돼\n너는 어때?",
    },
    {
    ...
    },
    {
        index:42,
        type: "story",
        backgroundImage: require("../../assets/Images/simple-10-3.png"),
        name: "세잎이",
        text: "그렇구나!\n그럼 이제 다시 여행 떠나는 거야?",
    },
    {
